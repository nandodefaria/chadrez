...
namespace xadrez
{
    ...
    public bool partidaTerminada;
        ...
        public void desfazerMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            // #jogada especial desfazer roque pequeno;
            ...
            //#jogada especial desfazer roque grande
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            if (estaEmXeque(jogadorAtual))
            {
                ...
                throw new TabuleiroException("Você não pode se colocar em xeque ou deve sair dele! Enter´para continuar...");
            }
